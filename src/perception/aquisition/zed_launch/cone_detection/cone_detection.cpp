...
void ZedLaunchNode::cone_detection_loop()
  {
    ...
    while (zed.grab() == sl::ERROR_CODE::SUCCESS) {
        ...
        detectionsMsg.car_pose.position.y = cam_w_pose.getTranslation().ty;
        detectionsMsg.car_pose.position.z = cam_w_pose.getTranslation().tz;
        detectionsMsg.car_pose.orientation.x = cam_w_pose.getOrientation().ox;
        detectionsMsg.car_pose.orientation.y = cam_w_pose.getOrientation().oy;
        detectionsMsg.car_pose.orientation.z = cam_w_pose.getOrientation().oz;
